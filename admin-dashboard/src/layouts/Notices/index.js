...
const Notices = () => {
  ...
  const url =
    "http://ec2-13-235-33-19.ap-south-1.compute.amazonaws.com:8080/events/"
  ...
  const getEvents = async () => {
    ...
    // let res = await axios.get("http://ec2-13-235-33-19.ap-south-1.compute.amazonaws.com:8080/events/")
    console.log(res)
    setNews(res.data)
  }
  ...
  const handleSubmit = async (e) => {
    ...
    fetch(url + "single", {
      // fetch("http://ec2-13-235-33-19.ap-south-1.compute.amazonaws.com:8080/events/single", {
      method: "POST",
      body: formData,
    })
      .then(async (result) => {
        ...
        try {
          ...
          // let res = await axios.post("http://ec2-13-235-33-19.ap-south-1.compute.amazonaws.com:8080/events/", data)
          console.log(res)
          setData({
            _id: 0,
            title: "",
  ...
  const actionDelete = async (id) => {
    try {
      ...
      // let res = await axios.delete("http://ec2-13-235-33-19.ap-south-1.compute.amazonaws.com:8080/events/", {
      //   data: {
      //     _id: id,
      //   },
      // })
